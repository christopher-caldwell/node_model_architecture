 ...
 * ```
 */
export const createMember = new PreparedQuery<
  ICreateMemberParams,
  ICreateMemberResult
>(createMemberIR);
 ...
 * ```
 */
export const getMemberById = new PreparedQuery<
  IGetMemberByIdParams,
  IGetMemberByIdResult
>(getMemberByIdIR);
 ...
 * ```
 */
export const getMemberByIdent = new PreparedQuery<
  IGetMemberByIdentParams,
  IGetMemberByIdentResult
>(getMemberByIdentIR);
...
const getMemberByIdentForUpdateIR: any = {
  usedParamSet: { member_ident: true },
  params: [
    {
      name: "member_ident",
 ...
 * ```
 */
export const getMemberByIdentForUpdate = new PreparedQuery<
  IGetMemberByIdentForUpdateParams,
  IGetMemberByIdentForUpdateResult
>(getMemberByIdentForUpdateIR);
...
const updateMemberStatusIR: any = {
  usedParamSet: { status: true, member_id: true },
  params: [
    {
      name: "status",
      required: true,
 ...
 * ```
 */
export const updateMemberStatus = new PreparedQuery<
  IUpdateMemberStatusParams,
  IUpdateMemberStatusResult
>(updateMemberStatusIR);
