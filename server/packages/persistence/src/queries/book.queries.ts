...
const createBookIR: any = {
  usedParamSet: { isbn: true, title: true, author_name: true },
  params: [
    {
      name: "isbn",
      required: true,
 ...
 * ```
 */
export const createBook = new PreparedQuery<
  ICreateBookParams,
  ICreateBookResult
>(createBookIR);
...
const getBookByIsbnIR: any = {
  usedParamSet: { isbn: true },
  params: [
    {
      name: "isbn",
      required: true,
 ...
 * ```
 */
export const getBookByIsbn = new PreparedQuery<
  IGetBookByIsbnParams,
  IGetBookByIsbnResult
>(getBookByIsbnIR);
 ...
 * ```
 */
export const getBookCatalog = new PreparedQuery<
  IGetBookCatalogParams,
  IGetBookCatalogResult
>(getBookCatalogIR);
