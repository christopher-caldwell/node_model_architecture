...
const createBookCopyIR: any = {
  usedParamSet: { book_id: true, status: true, barcode: true },
  params: [
    {
      name: "book_id",
      required: true,
 ...
 * ```
 */
export const createBookCopy = new PreparedQuery<
  ICreateBookCopyParams,
  ICreateBookCopyResult
>(createBookCopyIR);
 ...
 * ```
 */
export const getBookCopyById = new PreparedQuery<
  IGetBookCopyByIdParams,
  IGetBookCopyByIdResult
>(getBookCopyByIdIR);
...
const getBookCopyByBarcodeIR: any = {
  usedParamSet: { barcode: true },
  params: [
    {
      name: "barcode",
      required: true,
 ...
 * ```
 */
export const getBookCopyByBarcode = new PreparedQuery<
  IGetBookCopyByBarcodeParams,
  IGetBookCopyByBarcodeResult
>(getBookCopyByBarcodeIR);
...
const getBookCopyByBarcodeForUpdateIR: any = {
  usedParamSet: { barcode: true },
  params: [
    {
      name: "barcode",
 ...
 * ```
 */
export const getBookCopyByBarcodeForUpdate = new PreparedQuery<
  IGetBookCopyByBarcodeForUpdateParams,
  IGetBookCopyByBarcodeForUpdateResult
>(getBookCopyByBarcodeForUpdateIR);
...
const updateBookCopyStatusIR: any = {
  usedParamSet: { status: true, book_copy_id: true },
  params: [
    {
      name: "status",
      required: true,
 ...
 * ```
 */
export const updateBookCopyStatus = new PreparedQuery<
  IUpdateBookCopyStatusParams,
  IUpdateBookCopyStatusResult
>(updateBookCopyStatusIR);
