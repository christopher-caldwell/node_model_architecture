...
const createLoanIR: any = {
  usedParamSet: { book_copy_id: true, member_id: true },
  params: [
    {
      name: "book_copy_id",
      required: true,
 ...
 * ```
 */
export const createLoan = new PreparedQuery<
  ICreateLoanParams,
  ICreateLoanResult
>(createLoanIR);
 ...
 * ```
 */
export const endLoan = new PreparedQuery<IEndLoanParams, IEndLoanResult>(
  endLoanIR
);
...
const findActiveLoanByBookCopyIdIR: any = {
  usedParamSet: { book_copy_id: true },
  params: [
    {
      name: "book_copy_id",
      required: true,
 ...
 * ```
 */
export const findActiveLoanByBookCopyId = new PreparedQuery<
  IFindActiveLoanByBookCopyIdParams,
  IFindActiveLoanByBookCopyIdResult
>(findActiveLoanByBookCopyIdIR);
...
const findActiveLoanByBookCopyIdForUpdateIR: any = {
  usedParamSet: { book_copy_id: true },
  params: [
    {
      name: "book_copy_id",
 ...
 * ```
 */
export const findActiveLoanByBookCopyIdForUpdate = new PreparedQuery<
  IFindActiveLoanByBookCopyIdForUpdateParams,
  IFindActiveLoanByBookCopyIdForUpdateResult
>(findActiveLoanByBookCopyIdForUpdateIR);
...
const countActiveLoansByMemberIdIR: any = {
  usedParamSet: { member_id: true },
  params: [
    {
      name: "member_id",
      required: true,
 ...
 * ```
 */
export const countActiveLoansByMemberId = new PreparedQuery<
  ICountActiveLoansByMemberIdParams,
  ICountActiveLoansByMemberIdResult
>(countActiveLoansByMemberIdIR);
...
const getLoansByMemberIdentIR: any = {
  usedParamSet: { member_ident: true },
  params: [
    {
      name: "member_ident",
      required: true,
 ...
 * ```
 */
export const getLoansByMemberIdent = new PreparedQuery<
  IGetLoansByMemberIdentParams,
  IGetLoansByMemberIdentResult
>(getLoansByMemberIdentIR);
 ...
 * ```
 */
export const getOverdueLoans = new PreparedQuery<
  IGetOverdueLoansParams,
  IGetOverdueLoansResult
>(getOverdueLoansIR);
